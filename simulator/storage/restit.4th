...
\               - Show next brick
\               - Add sound effects
\ 2023-10-22: adapter to turnkey application.
...
136     VALUE LEFT-KEY		\ customize if you don't like them
139	VALUE ROT-KEY-R
...
: UDG
    CREATE C,
    DOES> 23 EMIT DUP C@ EMIT 8 0 DO 1+ DUP C@ EMIT LOOP DROP ;
...
: PR-CHAR      \ c1 ---
               DUP BL = IF EMIT ELSE 17 EMIT DUP 64 - 9 * EMIT 65 + EMIT THEN ;
...
: WALL-COLOUR 17 EMIT 1 EMIT 17 EMIT 135 EMIT ;
: NORMAL-COLOUR 17 EMIT 63 EMIT 17 EMIT 128 EMIT ;
...
: BOTTOM-MSG	\ addr cnt --- ; output a message in the bottom of the pit
		DEEP OVER 2/ WIDE SWAP - 2/ POSITION NORMAL-COLOUR TYPE ;
...
: WALLS ( n --- ) \ draw n wall characters
   WALl-COLOUR 0 DO 129 EMIT LOOP NORMAL-COLOUR ;
